...
//		TODO obtener el ultimo id
		try {
			...
			ps.executeUpdate();
			System.out.println("Inserto todos los datos");
	...
	private int getUltimoIdDeProducto() {
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("No pudo obtener el ultimo id " + e.getMessage(), e);
		}
	}
}
